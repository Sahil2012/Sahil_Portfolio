...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-x-hidden bg-slate-950 w-full z-0 pt-[180px]",
        className
      )}
    >
      ...
      <div className="relative z-50 mt-[-18rem]">
        {children}
      </div>
    </div>
  );
